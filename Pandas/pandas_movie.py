...
users = pd.read_csv('movie_lens/u.user', sep='|', names=user_columns, usecols=range(3), encoding = "ISO-8859-1")

rating_columns = ['user_id', 'movie_id', 'rating']
ratings = pd.read_csv('movie_lens/u.data', sep='\t', names=rating_columns,  usecols=range(3),encoding = "ISO-8859-1")
